#!/usr/bin/env bash
#
# Deploy a Fair-Forge metric as an AWS Lambda container image with HTTP API
#
...
#   - Fair-Forge repo at ../../.. (three levels up)
#
# Creates:
#   - ECR repository
#   - IAM role for Lambda
...
echo "=== Deploying Fair-Forge Lambda: $PROJECT_NAME ==="
