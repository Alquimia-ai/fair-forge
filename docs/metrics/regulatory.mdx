...
|---------|-----------|------------------|
| **COMPLIANT** | `compliance_score >= 0.5` | `supporting / (supporting + contradicting)` |
| **NON_COMPLIANT** | `compliance_score < 0.5` or all contradicting | `supporting / (supporting + contradicting)` |
| **IRRELEVANT** | No chunks retrieved | `0.5` (neutral) |
