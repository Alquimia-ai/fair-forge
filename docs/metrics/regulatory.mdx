...
|-----------|------|---------|-------------|
| `embedder` | `Embedder` | *(required)* | Embedder instance for encoding documents and queries (e.g., `QwenEmbedder`) |
| `reranker` | `Reranker` | *(required)* | Reranker instance for scoring document-response alignment (e.g., `QwenReranker`) |
